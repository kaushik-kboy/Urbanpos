    ...
    */
    'shortcuts' => [
        ...
        'purchase_return' => [
            ...
            'color'       => 'outline-danger',
            'route'       => 'purchase.purchase-returns.create',
            'permission'  => 'purchase-returns.create',
            'module'      => 'Purchase',
            'description' => 'Create vendor debit note & return goods',
        ],
        'purchase_indent' => [
            'key'         => 'purchase_indent',
            ...
            'color'       => 'outline-info',
            'route'       => 'purchase.purchase-indents.create',
            'permission'  => null,
            'module'      => 'Purchase',
            'description' => 'Internal store requisition & purchase indent',
        ],
        'damage_stock' => [
            'key'         => 'damage_stock',
            'title'       => 'Damage Stock',
            ...
            'color'       => 'outline-danger',
            'route'       => 'inventory.damage-stocks.create',
            'permission'  => 'damage-stocks.create',
            'module'      => 'Inventory',
            'description' => 'Write off expired or damaged store items',
        ],
        'stock_update' => [
            'key'         => 'stock_update',
            'title'       => 'Stock Audit / Adj',
            'icon'        => 'fas fa-clipboard-check',
            'color'       => 'outline-warning',
            'route'       => 'inventory.stock-updates.create',
            'permission'  => 'stock-updates.create',
            'module'      => 'Inventory',
            'description' => 'Physical stock count & adjustment entry',
        ],
        'voucher_entry' => [
            'key'         => 'voucher_entry',
            ...
            'color'       => 'outline-secondary',
            'route'       => 'finance.vouchers.create',
            'permission'  => 'vouchers.create',
            'module'      => 'Finance',
            'description' => 'Record store expenses, cash vouchers & payments',
        ],
        'sales_bills_list' => [
            'key'         => 'sales_bills_list',
            'title'       => 'Sales History',
            'icon'        => 'fas fa-receipt',
            'color'       => 'outline-primary',
            'route'       => 'sales.sales-bills.index',
            'permission'  => null,
            'module'      => 'Sales',
            'description' => 'Browse and filter all generated sales invoices',
        ],
        'quick_supplier' => [
            'key'         => 'quick_supplier',
            'title'       => 'New Supplier',
            'icon'        => 'fas fa-truck',
            'color'       => 'outline-dark',
            'route'       => 'master.suppliers.create',
            'permission'  => null,
            'module'      => 'Master',
            'description' => 'Onboard new vendor profile and contact',
        ],
        'smart_analytics' => [
            'key'         => 'smart_analytics',
