    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ['text' => 'Masters Reports', 'url' => 'reports?group=masters', 'icon' => 'fas fa-fw fa-book-open'],
                ['text' => 'Purchase Reports', 'url' => 'reports/purchase-detail', 'icon' => 'fas fa-fw fa-cart-arrow-down'],
                ['text' => 'Sales Reports', 'url' => 'reports/sales-summary', 'icon' => 'fas fa-fw fa-chart-line'],
                ['text' => 'EOD / Settlement', 'url' => 'reports/eod', 'icon' => 'fas fa-fw fa-calendar-check'],
                ['text' => 'Inventory Reports', 'url' => 'reports/current-stock', 'icon' => 'fas fa-fw fa-boxes'],
                ['text' => 'Audit Reports', 'url' => 'reports?group=audit', 'icon' => 'fas fa-fw fa-search-dollar'],
                ['text' => 'Customer Loyalty Report', 'url' => 'reports/customer-loyalty', 'icon' => 'fas fa-fw fa-star'],
                ['text' => 'My Reports', 'url' => 'reports?group=my-reports', 'icon' => 'fas fa-fw fa-folder-open'],
            ],
        ],
        [
            'text' => 'Tools',
