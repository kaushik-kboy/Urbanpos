        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'icon' => 'fas fa-fw fa-shopping-cart',
                    'submenu' => [
                        ['text' => 'Daily Sales Summary', 'url' => 'reports/sales-summary', 'icon' => 'fas fa-fw fa-chart-line'],
                        ['text' => 'Billwise Sales Detail', 'url' => 'reports/billwise-sales', 'icon' => 'fas fa-fw fa-receipt'],
                        ['text' => 'GST Sales Summary', 'url' => 'reports/gst-sales-summary', 'icon' => 'fas fa-fw fa-percentage'],
                        ['text' => 'Sales Return Summary', 'url' => 'reports/sales-return-summary', 'icon' => 'fas fa-fw fa-undo-alt'],
                        ['text' => 'Tender / Payment Summary', 'url' => 'reports/tender-summary', 'icon' => 'fas fa-fw fa-wallet'],
                        ['text' => 'EOD / Settlement Report', 'url' => 'reports/eod', 'icon' => 'fas fa-fw fa-calendar-check'],
                        ['text' => 'Sales Margin (Itemwise)', 'url' => 'reports/sales-margin-itemwise', 'icon' => 'fas fa-fw fa-coins'],
                        ['text' => 'Sales Margin (Category)', 'url' => 'reports/sales-margin-category', 'icon' => 'fas fa-fw fa-chart-pie'],
                        ['text' => 'Quotation & Order Summary', 'url' => 'reports/quotation-order-summary', 'icon' => 'fas fa-fw fa-file-invoice'],
                    ],
                ],
                [
                    ...
                    'icon' => 'fas fa-fw fa-truck',
                    'submenu' => [
                        ['text' => 'Purchase Invoice Detail', 'url' => 'reports/purchase-detail', 'icon' => 'fas fa-fw fa-cart-arrow-down'],
                        ['text' => 'GST Purchase Summary (ITC)', 'url' => 'reports/gst-purchase-summary', 'icon' => 'fas fa-fw fa-file-invoice-dollar'],
                ...
                [
                    ...
                    'submenu' => [
                        ...
                        ['text' => 'Stock Transfer Summary', 'url' => 'reports/stock-transfer-summary', 'icon' => 'fas fa-fw fa-exchange-alt'],
                        ['text' => 'Damage / Wastage Report', 'url' => 'reports/damage-stock-summary', 'icon' => 'fas fa-fw fa-heart-broken'],
                        ['text' => 'Re-order / Low Stock Report', 'url' => 'reports/reorder-report', 'icon' => 'fas fa-fw fa-exclamation-triangle'],
                    ],
                ],
                [
                    ...
                    'submenu' => [
                        ['text' => 'Item Master Report', 'url' => 'reports/item-master', 'icon' => 'fas fa-fw fa-box'],
                        ['text' => 'Supplier Master Report', 'url' => 'reports/supplier-master', 'icon' => 'fas fa-fw fa-truck-loading'],
                        ['text' => 'Customer Master Report', 'url' => 'reports/customer-master', 'icon' => 'fas fa-fw fa-users'],
                        ['text' => 'Customer Pet Details', 'url' => 'reports/customer-pet-details', 'icon' => 'fas fa-fw fa-paw'],
                        ['text' => 'Customer Loyalty Report', 'url' => 'reports/customer-loyalty', 'icon' => 'fas fa-fw fa-star'],
                    ],
                ],
                [
                    'text' => 'Audit Reports',
                    ...
                    'submenu' => [
                        ['text' => 'Audit Activity Logs', 'url' => 'reports/audit-logs', 'icon' => 'fas fa-fw fa-history'],
                    ],
                ],
                [
                    ...
                    'submenu' => [
                        ...
                        ['text' => 'Outstanding Aging', 'url' => 'finance/reports/outstanding-aging', 'icon' => 'fas fa-fw fa-hourglass-half'],
                        ['text' => 'Trial Balance', 'url' => 'finance/reports/trial-balance', 'icon' => 'fas fa-fw fa-balance-scale'],
                        ['text' => 'Profit & Loss', 'url' => 'finance/reports/profit-loss', 'icon' => 'fas fa-fw fa-chart-area'],
                    ],
                ],
            ],
        ],
        ...
        'Select2' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'js/select2-init.js?v=20260916_gstin1',
                ],
            ],
        ],
        'Chartjs' => [
