    ...
    <div class="card card-primary card-outline">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="card-tools d-flex align-items-center ml-auto">
                ...
                <button type="button" onclick="exportTableToCSV('damageStockTable', 'damage-stock-summary-report')" class="btn btn-sm btn-outline-success mr-2"><i class="fas fa-file-csv mr-1"></i> Export CSV</button>
