...
<tr>
    ...
    <td style="width: 85px;"><input type="text" readonly class="form-control form-control-sm pinv-margin bg-light text-right font-weight-bold" value="{{ $marginVal !== null && $marginVal != 0 ? number_format($marginVal, 2).'%' : '' }}" autocomplete="off" title="Margin % = ((Sell - Cost) / Sell) * 100"></td>
    <td style="width: 85px;"><input type="text" readonly class="form-control form-control-sm pinv-profit bg-light text-right font-weight-bold" value="{{ $profitVal !== null && $profitVal != 0 ? number_format($profitVal, 2).'%' : '' }}" autocomplete="off" title="Profit % = ((Sell - Cost) / Cost) * 100"></td>
