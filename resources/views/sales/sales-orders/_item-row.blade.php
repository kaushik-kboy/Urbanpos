...
<tr>
    ...
    <td style="width: 85px;">
        <input type="number" step="0.01" name="items[{{ $index }}][gst_percent]" value="{{ $gstPercentVal }}" class="form-control form-control-sm so-gst-percent text-right" autocomplete="off" placeholder="0%">
    </td>
