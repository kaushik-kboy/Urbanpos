...
@endphp
<tr>
    <td class="text-center align-middle font-weight-bold sq-sr-no" data-col-key="seq">{{ is_numeric($index) ? $index + 1 : 1 }}</td>
    ...
    <td style="width: 120px;" class="text-right align-middle font-weight-bold text-success sq-row-net" data-col-key="net_amt">{{ $netAmtVal }}</td>
