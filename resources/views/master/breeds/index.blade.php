...
@section('content')
    ...
    <div class="card card-primary card-outline">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title font-weight-bold mb-0"><i class="fas fa-dog mr-1"></i> Breed List</h3>
            <div class="card-tools d-flex align-items-center ml-auto">
                <a href="{{ route('master.breeds.create') }}" class="btn btn-primary btn-sm mr-2">
                    <i class="fas fa-plus mr-1"></i> Add Breed
                </a>
                <x-table-column-customizer table-key="master.breeds" table-id="breeds-table" button-class="btn btn-sm btn-outline-secondary mr-2" />
                <x-import-button :import-route="route('master.breeds.import')" :sample-route="route('master.breeds.import-sample')" title="Breed" />
            </div>
        </div>
        <div class="card-body p-0">
            <table id="breeds-table" class="table table-striped mb-0">
                <thead>
                    <tr>
                        <th>Breed Name</th>
                        <th>Pet Type</th>
