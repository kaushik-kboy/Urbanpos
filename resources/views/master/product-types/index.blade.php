...
@section('title', 'Product Types Master')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-boxes mr-2 text-primary"></i>Product Types Master</h1>
        <div>
            <a href="{{ route('master.product-types.create') }}" class="btn btn-primary font-weight-bold">
...
@section('content')
    ...
    <div class="card card-primary card-outline shadow-sm mb-3">
        <div class="card-body p-3">
            <form method="GET" action="{{ route('master.product-types.index') }}" class="form-row align-items-center">
                ...
                <div class="col-md-2">
                    @if(request('search'))
                        <a href="{{ route('master.product-types.index') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <tbody>
                    @forelse($productTypes as $index => $type)
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="{{ route('master.product-types.edit', $type) }}" class="btn btn-xs btn-outline-primary" title="Edit Product Type">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-4 text-muted">
                                <i class="fas fa-info-circle mr-1"></i> No Product Types found.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
