...
@section('content')
    ...
    <div class="card card-primary card-outline">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title font-weight-bold mb-0"><i class="fas fa-store mr-1"></i> Branch List</h3>
            <div class="card-tools d-flex align-items-center ml-auto">
                <a href="{{ route('master.branches.create') }}" class="btn btn-primary btn-sm mr-2">
                    <i class="fas fa-plus mr-1"></i> Add Branch
                </a>
                <x-table-column-customizer table-key="master.branches" table-id="branches-table" button-class="btn btn-sm btn-outline-secondary mr-2" />
        ...
        <div class="card-header bg-light border-bottom">
            <form method="GET" action="{{ route('master.branches.index') }}" class="row align-items-end">
                ...
                <div class="col-md-3 col-sm-12 mb-2">
                    ...
                    <a href="{{ route('master.branches.index') }}" class="btn btn-sm btn-outline-secondary">
