...
@section('content')
    ...
    <div class="card card-primary card-outline">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title font-weight-bold mb-0"><i class="fas fa-coins mr-1"></i> Tender Value List</h3>
            <div class="card-tools d-flex align-items-center ml-auto">
                <a href="{{ route('master.tender-type-values.create') }}" class="btn btn-primary btn-sm mr-2">
                    <i class="fas fa-plus mr-1"></i> Add Tender Type Value
                </a>
                <x-table-column-customizer table-key="master.tender-type-values" table-id="tender-type-values-table" button-class="btn btn-sm btn-outline-secondary mr-2" />
