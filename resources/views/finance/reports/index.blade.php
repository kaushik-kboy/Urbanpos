    ...
    <div class="card card-primary card-outline">
        <div class="card-body p-0">
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><a href="{{ route('finance.reports.cash-bank-book') }}"><i class="fas fa-money-check-alt mr-2 text-primary"></i> Cash & Bank Book</a></li>
                <li class="list-group-item"><a href="{{ route('finance.reports.outstanding-aging') }}"><i class="fas fa-hourglass-half mr-2 text-warning"></i> Billwise Outstanding Aging Report</a></li>
