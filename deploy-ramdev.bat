...
echo.
echo [1/2] Verifying Blade JavaScript Syntax locally...
call npm run test:blade-js
if %ERRORLEVEL% NEQ 0 (
    echo.
    echo [ERROR] Blade JavaScript syntax validation failed! Deployment aborted to protect production.
    pause
    exit /b 1
)

echo [2/2] Deploying to Ramdevcar Shop Server...
